...
<centre>
<img src="https://github.com/WalidMakdoud/termux-root-privileges/blob/main/images/Img2.jpg" alt="root termux" title="root termux" width="100%" />
</centre>
...
<pre>git clone https://github.com/WalidMakdoud/termux-root-privileges
<pre>cd root</pre>
...
<pre>apt-get update && apt upgrade-y && apt-get install git -y && git clone  https://github.com/WalidMakdoud/termux-root-privileges.git</pre>
...
# Copyright
<pre>© Copyright credits goes to Walid Makdoud. This tool is public tool anyone can use this tool.</pre>
